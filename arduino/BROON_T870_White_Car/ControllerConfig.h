...
constexpr uint8_t kSteeringSensorPin = A3;
...
// Current vehicle measured on A3: full electrical travel 0..1023 ADC and
// straight ahead at 512 ADC. Keep software targets away from both rails.
// Direction follows the previous T870 convention: left=high, right=low.
constexpr SteeringCalibration kSteeringCalibration = {1023, 1000, 512, 20,
                                                       0, false};
...
constexpr BroonT870::RcChannelCalibration kRcSteerCalibration = {900, 1470,
                                                                  2080};
...
constexpr uint8_t kSteeringRecoveryPwm = 70U;
...
constexpr uint8_t kSteeringRestartConfirmSamples = 3U;
...
static_assert(kSteeringSensorPin == A3,
              "Current vehicle steering potentiometer must use A3");
